...
from utils import get_network, WarmUpLR, most_recent_folder, most_recent_weights, best_acc_weights, last_epoch
# ---------------------------------------- #
...
if __name__ == '__main__':
    ...
    train(settings.EPOCH)
    acc = eval_training(settings.EPOCH)
